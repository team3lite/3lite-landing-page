        ...
        <div className="relative h-full w-full">
          <div className="relative w-full h-full z-10">
            ...
            <div className="flex md:h-[500px] items-center justify-center flex-col gap-y-7 mt-5">
              ...
              >
                <h1>
                  Secure Messaging for the <br className="hidden md:block" />{" "}
              ...
              <p className="text-white font-Poppins text-lg md:text-base sm:leading-[32.4px] sm:text-[24px] w-[300px] md:w-1/2 sm:w-[500px] font-extralight text-center">
                Building a decentralized world with the future of secure world
                of messaging for both new users and old users
              </p>

              <div className="flex flex-col md:flex-row gap-3">
                <WalletConnectionHandler />
                <button className="bg-brand-light px-4 py-2 rounded-lg">
                  Launch Bot
                </button>
                <button className="bg-[#C2C0F3] px-4 py-2 rounded-lg text-brand">
                  Join community
                </button>
              </div>
            </div>
